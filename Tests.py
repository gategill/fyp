...
class Tests(unittest.TestCase):
    ...
    def test_user_rec(self):
        ...
        self.assertEqual(test["item_id"], 109, "Should be 109")
    ...
    def test_item_rec(self):
        ...
        self.assertEqual(test["item_id"], 943, "Should be 943")
    ...
    def test_bootstrap_rec(self):
        ...
        self.assertEqual(test["item_id"], 366, "Should be 366")
        self.assertEqual(test["rating"], 4.0, "Should be 4.0")
    ...
    def test_pearlpu_rec(self):
        ...
        self.assertEqual(test["item_id"], 174, "Should be 174")
